...
export const Projects = ({ onProjectSelect }) => (
  <section id="work" data-testid="projects-section" className="px-6 md:px-12 py-32 bg-[#eae9e5] dark:bg-[#151513] transition-colors duration-300">
    <div className="max-w-[1400px] mx-auto">
      ...
      <div className="mt-16 border-t border-black/[0.12] dark:border-white/[0.12]">
        {PROJECTS.map((p, i) => (
          <motion.button
            type="button"
            ...
            className="project-row w-full text-left grid grid-cols-12 items-center gap-4 py-8 border-b border-black/[0.12] dark:border-white/[0.12] px-2 cursor-pointer"
          >
            ...
            <span className="project-meta hidden md:block col-span-4 text-sm text-[#5c5c5c] dark:text-[#a3a39e]">{p.desc}</span>
